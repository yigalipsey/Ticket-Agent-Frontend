...
export function OfferCard({ offer }: OfferCardProps) {
  ...
  return (
    <div className="bg-white border-t border-b border-gray-200 p-2 md:p-4 hover:bg-gray-50 transition-colors">
      <div className="flex flex-row items-center gap-2 md:gap-4">
        ...
        <div className="flex-shrink-0 flex">
          <div className="flex items-center gap-0.5 md:gap-1">
            ...
            <span className="text-xs md:text-sm text-gray-600 ml-0.5 md:ml-1">
              {rating}
            </span>
          </div>
        </div>
