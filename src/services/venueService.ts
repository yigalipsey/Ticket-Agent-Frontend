...
export class VenueService {
  ...
  /**
   * קבלת אצטדיונים מכל הליגות (כולל פופולריים)
   */
  static async getStadiums(params?: {
    page?: number;
    limit?: number;
    isPopular?: boolean;
    country?: string;
   ...
   */
  static async getVenueById(id: string): Promise<ServiceResult<Venue>> {
    try {
      const venue = await apiClient.get<Venue>(`${API_ENDPOINTS.VENUES}/${id}`);
